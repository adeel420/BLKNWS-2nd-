...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white flex flex-col z-40 relative items-center justify-center gap-5 sm:gap-6 py-12 sm:py-16 px-4">
      <div className="flex flex-row ml-[-26px] items-center gap-8 text-[11px] text-xs sm:text-sm">
        <Link
          to="/rsvp"
      ...
      <p className="text-center text-xs ml-[-26px] sm:text-sm md:text-base">
      ...
      <img
        ...
        className="h-8 sm:h-10 md:h-10 ml-[-26px] w-auto object-contain"
      />

      <div className="text-white flex ml-[-26px] items-center gap-6">
        <a
